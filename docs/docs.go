...
const docTemplate = `{
            ...
            "post": {
                ...
                "responses": {
                    "201": {
                        "description": "Created",
                        "schema": {
                            "$ref": "#/definitions/domain.RegisterResponseDTO"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/domain.CategoryListItemResponseDTO"
                            }
                        }
                    },
                    "500": {
        ...
        "/helper": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Substring match on helper name (case-insensitive)",
                        "name": "name",
                        "in": "query"
                    },
                    {
                        "type": "integer",
                        "description": "Filter helpers by assigned category ID",
                        "name": "category_id",
                        "in": "query"
                    },
                    {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/domain.HelperListResponseDTO"
                        }
                    },
                    "401": {
                        "description": "Unauthorized",
        ...
        "/image-uploader/{image-type}/{id}": {
            "post": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Image type (profile-images | service-images)",
                        "name": "image-type",
                        "in": "path",
                        "required": true
                    },
        ...
        "/proposal": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Filter by proposal status (pending, accepted, refused, in progress, cancelled, finished)",
                        "name": "status",
                        "in": "query"
                    }
                ],
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/domain.ProposalResponseDTO"
                            }
                        }
                    },
                    "500": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/domain.CreateProposalRequestDTO"
                        }
                    }
                ],
                "responses": {
            ...
            "patch": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/domain.UpdateProposalStatusRequestDTO"
                        }
                    }
                ],
                "responses": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/domain.ServiceResponseDTO"
                            }
                        }
                    },
                    "401": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/domain.CreateServiceRequestDTO"
                        }
                    }
                ],
                "responses": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/domain.UpdateServiceRequestDTO"
                        }
                    }
                ],
                "responses": {
        ...
        "/user/profile/{id}": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "integer",
                        "description": "Filter services by category ID (business only)",
                        "name": "category_id",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "Filter services by actuation day (business only)",
                        "name": "actuation_day",
                        "in": "query"
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/domain.GetProfileResponseDTO"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
    ...
    "definitions": {
        ...
        "domain.CategoryListItemResponseDTO": {
            "type": "object",
            "properties": {
                "created_at": {
                    "type": "string"
        ...
        "domain.GetProfileResponseDTO": {
            "type": "object",
            "properties": {
                "address": {
                    "$ref": "#/definitions/domain.ProfileAddressDTO"
                },
                "biography": {
                    "type": "string"
                },
                "categories": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/domain.ProfileCategoryDTO"
                    }
                },
                "created_at": {
                    "type": "string"
        ...
        "domain.HelperCardDTO": {
            ...
            "properties": {
                ...
                "categories": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/domain.HelperCategoryDTO"
                    }
                },
                "city": {
                    "type": "string"
        ...
        "domain.HelperListResponseDTO": {
            "type": "object",
            "properties": {
                "data": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/domain.HelperCardDTO"
                    }
                },
                "page": {
                    "type": "integer"
        ...
        "domain.RegisterRequestDTO": {
            ...
            "properties": {
                "address": {
                    "$ref": "#/definitions/domain.AddressInputDTO"
                },
                "categories": {
                    "type": "array",
                    "minItems": 1,
        ...
        "domain.ServiceResponseDTO": {
            ...
            "properties": {
                ...
                "category": {
                    "$ref": "#/definitions/domain.ServiceCategoryDTO"
                },
                "description": {
                    "type": "string"
                },
        ...
        "domain.UpdateProfileRequestDTO": {
            ...
            "properties": {
                "address": {
                    "$ref": "#/definitions/domain.AddressUpdateDTO"
                },
                "biography": {
                    "type": "string"
                },
        ...
        "domain.UpdateProposalStatusRequestDTO": {
            "type": "object",
            "required": [
                "status"
            ],
        ...
        "domain.UpdateServiceRequestDTO": {
            "type": "object",
            "properties": {
                "actuation_days": {
                    "type": "array",
