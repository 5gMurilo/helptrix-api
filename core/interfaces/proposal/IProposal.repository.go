...
type IProposalRepository interface {
	...
	ListByUserID(userID uuid.UUID, statusFilter string, p domain.PaginationParams) ([]domain.ProposalResponseDTO, error)
	ListByHelperID(helperID uuid.UUID, statusFilter string, p domain.PaginationParams) ([]domain.ProposalResponseDTO, error)
